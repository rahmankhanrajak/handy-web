        ...
        <div className="mt-auto flex items-center justify-between">
          ...
          {hasVariants(product) ? (
            <button
              ...
              className={`px-2 sm:px-3 py-1 sm:py-1.5 rounded-lg sm:rounded-xl text-[11px] sm:text-xs font-bold border-2 transition-all duration-300 transform hover:scale-110 active:scale-95 shadow-lg ${
                added
